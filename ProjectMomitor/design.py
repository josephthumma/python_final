...
"")
        ...
        self.mac1 = QtWidgets.QLabel(self.centralwidget)
        self.mac1.setObjectName("mac1")
        self.verticalLayout_2.addWidget(self.mac1)
        self.mac2 = QtWidgets.QLabel(self.centralwidget)
        self.mac2.setObjectName("mac2")
        self.verticalLayout_2.addWidget(self.mac2)
        self.loadavg = QtWidgets.QLabel(self.centralwidget)
        self.loadavg.setObjectName("loadavg")
        self.verticalLayout_2.addWidget(self.loadavg)
        self.networktraffic = QtWidgets.QLabel(self.centralwidget)
        self.networktraffic.setObjectName("networktraffic")
        self.verticalLayout_2.addWidget(self.networktraffic)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.mac1.setText(_translate("MainWindow", "Internet download speed"))
        self.mac2.setText(_translate("MainWindow", "Internet Upload Speed"))
        self.loadavg.setText(_translate("MainWindow", "LoadAverage"))
        self.networktraffic.setText(_translate("MainWindow", "networktraffic"))
